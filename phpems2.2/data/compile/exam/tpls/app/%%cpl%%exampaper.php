 ...
 $eid++; ?>
					<li class="span2">
						<div class="thumbnail">
							...
							<div class="caption">
								<p class="text-center">
									<a class="ajax btn btn-primary" href="index.php?exam-app-exampaper-selectquestions&examid=<?php echo $exam['examid']; ?>" title="<?php echo $exam['exam']; ?>"><?php echo $this->G->make('strings')->subString($exam['exam'],28); ?></a>
								</p>
							</div>
						</div>
					</li>

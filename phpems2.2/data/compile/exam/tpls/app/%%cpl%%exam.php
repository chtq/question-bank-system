				...
				<?php if($this->tpl_var['data']['currentbasic']['basicexam']['opentime']['start'] && $this->tpl_var['data']['currentbasic']['basicexam']['opentime']['end']){ ?>
					<?php if($this->tpl_var['data']['currentbasic']['basicexam']['opentime']['start'] <= TIME && $this->tpl_var['data']['currentbasic']['basicexam']['opentime']['end'] >= TIME){ ?>
						...
						<div>
							...
							<?php } else { ?>
							<div class="span4 text-center"><a class="ajax btn btn-primary" href="index.php?exam-app-exam-selectquestions&examid=<?php echo $exam['examid']; ?>">开始考试</a></div>
							<?php } ?>
							<div class="span4"></div>
						</div>
						<?php } else { ?>
								...
								<div class="thumbnail">
									...
									<div class="caption">
										<p class="text-center">
											...
											<?php } else { ?>
											<a class="ajax btn btn-primary" href="index.php?exam-app-exam-selectquestions&examid=<?php echo $exam['examid']; ?>" title="<?php echo $exam['exam']; ?>"><?php echo $this->G->make('strings')->subString($exam['exam'],28); ?></a>
											<?php } ?>
										</p>
									</div>
								</div>
